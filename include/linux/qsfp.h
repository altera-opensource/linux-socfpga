...
enum {
	...
	SFF8024_QSFP_DD_CONNECTOR_COPPER = 0x6D,
	...
	/* SFF8636 Rev2.11 Specification Compliance Code */
	/* Byte 131 */
	SFF8636_QSFP_ECC_EXTENDED		= BIT(7),
	SFF8636_QSFP_ECC_10GBASE_LRM		= BIT(6),
	SFF8636_QSFP_ECC_10GBASE_LR		= BIT(5),
	SFF8636_QSFP_ECC_10GBASE_SR		= BIT(4),
	SFF8636_QSFP_ECC_40GBASE_CR4		= BIT(3),
	SFF8636_QSFP_ECC_40GBASE_SR4		= BIT(2),
	SFF8636_QSFP_ECC_40GBASE_LR4		= BIT(1),
	SFF8636_QSFP_ECC_40G_ACTIVE_CABLE	= BIT(0),
	...
	SFF8024_QSFP_SCC_1000BASE_T	= BIT(3),
	SFF8024_QSFP_SCC_1000BASE_CX	= BIT(2),
	SFF8024_QSFP_SCC_1000BASE_LX	= BIT(1),
	SFF8024_QSFP_SCC_1000BASE_SX	= BIT(0),
	...
	SFF8024_QSFP_SCC_FC_SPEED_1200	= BIT(7),
	SFF8024_QSFP_SCC_FC_SPEED_800	= BIT(6),
	SFF8024_QSFP_SCC_FC_SPEED_1600	= BIT(5),
	SFF8024_QSFP_SCC_FC_SPEED_400	= BIT(4),
	SFF8024_QSFP_SCC_FC_SPEED_3200	= BIT(3),
	SFF8024_QSFP_SCC_FC_SPEED_200	= BIT(2),
	SFF8024_QSFP_SCC_FC_EXTENDED	= BIT(1),
	SFF8024_QSFP_SCC_FC_SPEED_100	= BIT(0),
};
...
enum {
	...
	QSFP_SFF8472_COMPLIANCE_REV12_0 = 0x08,
...
void get_cable_info(char *vendor_name);
...
struct qsfp_bus *qsfp_bus_find_fwnode(const struct fwnode_handle *fwnode);
...
qsfp_bus_find_fwnode(const struct fwnode_handle *fwnode)
{
	return NULL;
}
