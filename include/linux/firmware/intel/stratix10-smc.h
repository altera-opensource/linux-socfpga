...
/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_OPEN_CS_SESSION
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_OPEN_CS_SESSION (0x13A)
#define ALTERA_SIP_SMC_ASYNC_FCS_OPEN_CS_SESSION \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_OPEN_CS_SESSION)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_CLOSE_CS_SESSION
 * Async call to close a service session
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_CLOSE_CS_SESSION
 * a1 transaction job id
 * a2 session ID
 * a3-a17 not used
 *
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CLOSE_CS_SESSION (0x13B)
#define ALTERA_SIP_SMC_ASYNC_FCS_CLOSE_CS_SESSION \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CLOSE_CS_SESSION)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_IMPORT_CS_KEY
 * Async call to import crypto service key to the device
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_IMPORT_CS_KEY
 * a1 transaction job id
 ...
 * a1-17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_IMPORT_CS_KEY (0x13C)
#define ALTERA_SIP_SMC_ASYNC_FCS_IMPORT_CS_KEY \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_IMPORT_CS_KEY)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_EXPORT_CS_KEY
 * Async call to export crypto service key from the device
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_EXPORT_CS_KEY
 * a1 transaction job id
 * a2 session ID
 * a3 key UID
 ...
 * a1-17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_EXPORT_CS_KEY (0x13D)
#define ALTERA_SIP_SMC_ASYNC_FCS_EXPORT_CS_KEY \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_EXPORT_CS_KEY)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_REMOVE_CS_KEY
 * Async call to remove the crypto service kers from the device
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_REMOVE_CS_KEY
 * a1 transaction job id
 * a2 session ID
 * a3 key UID
 * a4-a17 not used
 ...
 * a1-17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_REMOVE_CS_KEY (0x13E)
#define ALTERA_SIP_SMC_ASYNC_FCS_REMOVE_CS_KEY \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_REMOVE_CS_KEY)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_GET_CS_KEY_INFO
 * Sync call to query the crypto service keys on the device
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_GET_CS_KEY_INFO
 * a1 transaction job id
 * a2 session ID
 * a3 key UID
 ...
 * a1-17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_CS_KEY_INFO (0x13F)
#define ALTERA_SIP_SMC_ASYNC_FCS_GET_CS_KEY_INFO \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_CS_KEY_INFO)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_RANDOM_NUMBER_EXT
 *
 * Async call used to query the random number generated by the firmware,
 * the maxim random number is 4080 bytes.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_RANDOM_NUMBER_EXT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_RANDOM_NUMBER_EXT (0x12D)
#define ALTERA_SIP_SMC_ASYNC_FCS_RANDOM_NUMBER_EXT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_RANDOM_NUMBER_EXT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_GET_PROVISION_DATA
 * Async call to dump all the fuses and key hashes
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_GET_PROVISION_DATA
 * a1 transaction job id
 ...
 *
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_PROVISION_DATA (0x132)
#define ALTERA_SIP_SMC_ASYNC_FCS_GET_PROVISION_DATA \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_PROVISION_DATA)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_SEND_CERTIFICATE
 * Async call to send a signed certificate
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_SEND_CERTIFICATE
 * a1 transaction job id
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_SEND_CERTIFICATE (0x131)
#define ALTERA_SIP_SMC_ASYNC_FCS_SEND_CERTIFICATE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_SEND_CERTIFICATE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_CNTR_SET_PREAUTH
 * Async call to update counter value w/o signed certificate
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_CNTR_SET_PREAUTH
 * a1 transaction job id
 * a2 counter type
 * a3 counter value
 * a4 test bit
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CNTR_SET_PREAUTH (0x133)
#define ALTERA_SIP_SMC_ASYNC_FCS_CNTR_SET_PREAUTH \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CNTR_SET_PREAUTH)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_HKDF_REQUEST
 * Sync call to send the request on performing HKDF extract or expand with
 * input key and data.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_HKDF_REQUEST
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FCS_FUNC_ID_HKDF_REQUEST (0x166)
#define ALTERA_SIP_SMC_ASYNC_FCS_HKDF_REQUEST \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FCS_FUNC_ID_HKDF_REQUEST)
/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_CREATE_CRYPTO_SERVICE_KEY
 * Async call to create crypto service key to the device
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_CREATE_CRYPTO_SERVICE_KEY
 * a1 transaction job id
 * a2 physical address of the service key object with header
 * a3 size of the service key object
 * a4-a17 not used
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CREATE_CRYPTO_SERVICE_KEY (0x167)
#define ALTERA_SIP_SMC_ASYNC_FCS_CREATE_CRYPTO_SERVICE_KEY \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CREATE_CRYPTO_SERVICE_KEY)

/**
 * Request ALTERA_SIP_SMC_ASYNC_GET_IDCODE
 * Async call to retrieve the JTAG IDCODE
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_GET_IDCODE
 * a1 transaction job id
 * a2-a17 not used
 *
 * Return status:
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_GET_IDCODE (0xD3)
#define ALTERA_SIP_SMC_ASYNC_GET_IDCODE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_GET_IDCODE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_GET_DEVICE_IDENTITY
 * Async call to retrieve device identity Hashed Message
 * Authentication Code
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_GET_DEVICE_IDENTITY
 * a1 transaction job id
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_GET_DEVICE_IDENTITY (0xD2)
#define ALTERA_SIP_SMC_ASYNC_GET_DEVICE_IDENTITY \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_GET_DEVICE_IDENTITY)

/**
 * Request ALTERA_SIP_SMC_ASYNC_QSPI_OPEN
 * Async call to open QSPI device through SDM for client
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_OPEN
 * a1 transaction job id
 * a2-a17 not used
 *
 * Return status:
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_OPEN (0xCC)
#define ALTERA_SIP_SMC_ASYNC_QSPI_OPEN \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_OPEN)

/**
 * Request ALTERA_SIP_SMC_ASYNC_QSPI_CLOSE
 * Async call to close QSPI device through SDM for client.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_QSPI_CLOSE
 * a1 transaction job id
 * a2-a17 not used
 *
 * Return status:
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_CLOSE (0xCD)
#define ALTERA_SIP_SMC_ASYNC_QSPI_CLOSE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_CLOSE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_QSPI_SET_CS
 * Async call to close QSPI device through SDM for client.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_QSPI_SET_CS
 * a1 transaction job id
 * a2 QSPI CS number
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_SET_CS (0xCE)
#define ALTERA_SIP_SMC_ASYNC_QSPI_SET_CS \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_SET_CS)

/**
 * Request ALTERA_SIP_SMC_ASYNC_QSPI_ERASE
 * Async call to erase QSPI device through SDM for client.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_QSPI_ERASE
 * a1 transaction job id
 * a2 erase address
 * a3 erase size
 * a4-a17 not used
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_ERASE (0xCF)
#define ALTERA_SIP_SMC_ASYNC_QSPI_ERASE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_ERASE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_QSPI_WRITE
 * Async call to write to QSPI device through SDM for client.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_QSPI_WRITE
 * a1 transaction job id
 * a2 write address
 * a3 physical address of the payload buffer
 * a4 write size
 * a5-a17 not used
 *
 * Return status:
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_WRITE (0xD0)
#define ALTERA_SIP_SMC_ASYNC_QSPI_WRITE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_WRITE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_QSPI_READ
 * Async call to read from QSPI device through SDM for client.
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_QSPI_READ
 * a1 transaction job id
 * a2 read address
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_READ (0xD1)
#define ALTERA_SIP_SMC_ASYNC_QSPI_READ \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_QSPI_READ)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_MCTP
 * Async call to send MCTP message
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_MCTP
 * a1 transaction job id
 * a2 payload address
 * a3 payload size
 * a4 response address
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MCTP (0x165)
#define ALTERA_SIP_SMC_ASYNC_FCS_MCTP \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MCTP)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_INIT
 * Async call to initialize the SHA-2 hash digest on a blob
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_DIGEST_INIT (0x143)
#define ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_DIGEST_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_UPDATE
 * Async call to update the SHA-2 hash digest on a blob
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_UPDATE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 ...
 * a1-a17 not used
 */
#define  ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_DIGEST_UPDATE (0x144)
#define  ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_UPDATE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_DIGEST_UPDATE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_FINALIZE
 * Async call to finalize the SHA-2 hash digest on a blob
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_DIGEST_FINALIZE (0x145)
#define ALTERA_SIP_SMC_ASYNC_FCS_GET_DIGEST_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_DIGEST_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_INIT
 * Async call to initialize the MAC verification on a blob
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MAC_VERIFY_INIT (0x148)
#define ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MAC_VERIFY_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_UPDATE
 * Async call to update the MAC verification on a blob
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_UPDATE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MAC_VERIFY_UPDATE (0x149)
#define ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_UPDATE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MAC_VERIFY_UPDATE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_FINALIZE
 * Async call to finalize the MAC verification on a blob
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MAC_VERIFY_FINALIZE (0x14A)
#define ALTERA_SIP_SMC_ASYNC_FCS_MAC_VERIFY_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_MAC_VERIFY_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_INIT
 * Async call to initialize AES crypto operation
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_AES_CRYPT_INIT (0x140)
#define ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_AES_CRYPT_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_UPDATE
 * Async call to update AES crypto operation
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_UPDATE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a11-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_AES_CRYPT_UPDATE (0x141)
#define ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_UPDATE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_AES_CRYPT_UPDATE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_FINALIZE
 * Async call to finalize AES crypto operation
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_AES_CRYPT_FINALIZE (0x142)
#define ALTERA_SIP_SMC_ASYNC_FCS_AES_CRYPT_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_AES_CRYPT_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_CHIP_ID
 * Async call to retrieve the chip ID
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_CHIP_ID
 * a1 transaction job id
 * a2-a17 not used
 *
 * Return status:
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CHIP_ID (0x135)
#define ALTERA_SIP_SMC_ASYNC_FCS_CHIP_ID \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CHIP_ID)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_GET_ATTESTATION_CERT
 * Async call to get the attestation certificate
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_GET_ATTESTATION_CERT
 * a1 transaction job id
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_ATTESTATION_CERT (0x138)
#define ALTERA_SIP_SMC_ASYNC_FCS_GET_ATTESTATION_CERT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_GET_ATTESTATION_CERT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_CREATE_CERT_ON_RELOAD
 * Async call to create certificate on reload
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_CREATE_CERT_ON_RELOAD
 * a1 transaction job id
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CREATE_CERT_ON_RELOAD (0x139)
#define ALTERA_SIP_SMC_ASYNC_FCS_CREATE_CERT_ON_RELOAD \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CREATE_CERT_ON_RELOAD)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_CRYPTION_EXT
 * Async call to perform encryption/decryption
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_CRYPTION_EXT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CRYPTION_EXT (0x12D)
#define ALTERA_SIP_SMC_ASYNC_FCS_CRYPTION_EXT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_CRYPTION_EXT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_GET_PUBKEY_INIT
 * Async call to send the request to get the public key
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_GET_PUBKEY_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_GET_PUBKEY_INIT (0x160)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_GET_PUBKEY_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_GET_PUBKEY_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_GET_PUBKEY_FINALIZE
 * Async call to send the request to get the public key
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_GET_PUBKEY_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_GET_PUBKEY_FINALIZE (0x161)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_GET_PUBKEY_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_GET_PUBKEY_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDH_REQUEST_INIT
 * Async call to send the request on generating a share secret on
 * Diffie-Hellman key exchange
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDH_REQUEST_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDH_REQUEST_INIT (0x162)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDH_REQUEST_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDH_REQUEST_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDH_REQUEST_FINALIZE
 * Async call to send the request on generating a share secret on
 * Diffie-Hellman key exchange
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDH_REQUEST_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDH_REQUEST_FINALIZE (0x163)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDH_REQUEST_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDH_REQUEST_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIG_VERIFY_INIT
 * Async call to send digital signature verify request with precalculated hash
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIG_VERIFY_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIG_VERIFY_INIT (0x154)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIG_VERIFY_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIG_VERIFY_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIG_VERIFY_FINALIZE
 * Async call to send final stage of digital signature verify request
 * with precalculated hash
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIG_VERIFY_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIG_VERIFY_FINALIZE (0x155)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIG_VERIFY_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIG_VERIFY_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_INIT
 * Async call to send digital signature verify request
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_INIT (0x156)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_UPDATE
 * Async call to send digital signature verify request
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_UPDATE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 ...
 * or INTEL_SIP_SMC_STATUS_BUSY
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_UPDATE (0x157)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_UPDATE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_UPDATE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_FINALIZE
 * Async call to send final stage of digital signature verify request
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source (contain user data)
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_FINLZE (0x158)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIG_VERIFY_FINLZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIGN_INIT
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIGN_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIGN_INIT (0x14D)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIGN_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIGN_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIGN_FINALIZE
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIGN_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 *
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIGN_FINALIZE (0x14E)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_HASH_SIGN_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_HASH_SIGN_FINALIZE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_INIT
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_INIT
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 key UID
 ...
 * a1-a17 not used
 */
 #define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIGN_INIT (0x14F)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_INIT \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIGN_INIT)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_UPDATE
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_UPDATE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIGN_UPDATE (0x150)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_UPDATE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIGN_UPDATE)

/**
 * Request ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_FINALIZE
 *
 * Call register usage:
 * a0 ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_FINALIZE
 * a1 transaction job id
 * a2 session ID
 * a3 context ID
 * a4 physical address of source
 ...
 * a1-a17 not used
 */
#define ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIGN_FINALIZE (0x151)
#define ALTERA_SIP_SMC_ASYNC_FCS_ECDSA_SHA2_DATA_SIGN_FINALIZE \
	ALTERA_SIP_SMC_ASYNC_VAL(ALTERA_SIP_SMC_ASYNC_FUNC_ID_FCS_ECDSA_SHA2_DATA_SIGN_FINALIZE)
#endif
