 ...
 *
 * Async call to get the device IDCODE.
 *
 * Call register usage:
 ...
 *
 * Async call to get the device identity.
 *
 * Call register usage:
 * a0 INTEL_SIP_SMC_ASYNC_GET_DEVICE_IDENTITY
 * a1 transaction job id
 * a2 buffer pointer for output data
 * a3 size of the output buffer
 * a4-a17 not used
 *
 * Return status:
 * a0 INTEL_SIP_SMC_STATUS_OK, INTEL_SIP_SMC_STATUS_REJECTED
 ...
 *
 * Async call to open the QSPI proxy.
 *
 * Call register usage:
 * a0 INTEL_SIP_SMC_ASYNC_QSPI_OPEN
 * a1 transaction job id
 * a2-a17 not used
 *
 * Return status:
 ...
 *
 * Async call to close the QSPI proxy.
 *
 * Call register usage:
 ...
 *
 * Async call to set the QSPI proxy chip select.
 *
 * Call register usage:
 * a0 INTEL_SIP_SMC_ASYNC_QSPI_SET_CS
 * a1 transaction job id
 * a2 chip select value
 * a3 chip select mode
 * a4 chip select options
 * a5-a17 not used
 *
 * Return status:
 * a0 INTEL_SIP_SMC_STATUS_OK, INTEL_SIP_SMC_STATUS_REJECTED
 ...
 *
 * Async call to read from the QSPI proxy.
 *
 * Call register usage:
 * a0 INTEL_SIP_SMC_ASYNC_QSPI_READ
 * a1 transaction job id
 * a2 address to read from
 * a3 buffer pointer for output data
 * a4 size of the output buffer
 * a5-a17 not used
 *
 * Return status:
 * a0 INTEL_SIP_SMC_STATUS_OK, INTEL_SIP_SMC_STATUS_REJECTED
 ...
 *
 * Async call to write to the QSPI proxy.
 *
 * Call register usage:
 * a0 INTEL_SIP_SMC_ASYNC_QSPI_WRITE
 * a1 transaction job id
 * a2 buffer pointer for input data
 * a3 size of the input data
 * a4-a17 not used
 *
 * Return status:
 * a0 INTEL_SIP_SMC_STATUS_OK, INTEL_SIP_SMC_STATUS_REJECTED
 ...
 *
 * Async call to erase the QSPI proxy.
 *
 * Call register usage:
 ...
 *
 * Async call to send an MCTP message.
 *
 * Call register usage:
 ...
 * a2 buffer pointer for input data
 * a3 size of the input data
 * a4 buffer pointer for output data
 * a5 size of the output buffer
 * a6-a17 not used
 *
 * Return status:
 * a0 INTEL_SIP_SMC_STATUS_OK, INTEL_SIP_SMC_STATUS_REJECTED
 ...
 * Async call to perform SDOS encryption/decryption
 *
 * Call register usage:
 ...
 * Async call to send the request to get the public key (finalize)
 *
 * Call register usage:
 ...
 * Async call to send ECDH request (init stage)
 *
 * Call register usage:
 ...
 * Async call to send ECDH request (finalize stage)
 *
 * Call register usage:
