...
static inline void fpga_mgr_debugfs_add(struct fpga_manager *mgr) {}
static inline void fpga_mgr_debugfs_remove(struct fpga_manager *mgr) {}
static inline void fpga_mgr_debugfs_init(void) {}
static inline void fpga_mgr_debugfs_uninit(void) {}
